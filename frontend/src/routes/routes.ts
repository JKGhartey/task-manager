...
export const ROUTES = {
  ...
  ADMIN: {
    ...
    MANAGE_TEAMS: "/admin/manage-teams",
    MANAGE_PROJECTS: "/admin/manage-projects",
...
export const NAVIGATION_ROUTES = {
  ...
  admin: [
    ...
    { path: ROUTES.ADMIN.MANAGE_TEAMS, label: "Manage Teams" },
    { path: ROUTES.ADMIN.MANAGE_PROJECTS, label: "Manage Projects" },
